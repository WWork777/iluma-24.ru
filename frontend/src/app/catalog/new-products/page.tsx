...
export const metadata: Metadata = {
  title: "Новинки IQOS Iluma и Terea | Последние поступления | iluma-24",
  description:
  ...
  alternates: {
    canonical: "https://iluma-24.ru/new-products",
  },
};
